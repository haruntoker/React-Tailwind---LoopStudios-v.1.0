  ...
  <div className="container flex flex-col py-8 px-4 mx-auto max-w-screen-4xl sm:py-16 lg:px-6">
    ...
    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
      <div className='flex flex-col items-center text-center'>
        <div className="relative flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
        ...
        <h3 className="mb-2 text-xl font-bold dark:text-white text-center">Marketing</h3>
